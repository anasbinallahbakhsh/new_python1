...
# --------------------------------------------------------------------------
CHICKEN_TYPES = {
    "normal": {"speed": 55,  "hp": 1, "points": 10, "radius": 20, "color": (255, 240, 230)},
    "fast":   {"speed": 90,  "hp": 1, "points": 20, "radius": 16, "color": (255, 220, 150)},
    "tank":   {"speed": 35,  "hp": 3, "points": 35, "radius": 26, "color": (230, 200, 190)},
    "boss":   {"speed": 45,  "hp": 15, "points": 200, "radius": 46, "color": (255, 180, 90)},
}
...
def main():
    ...
    while running:
        ...
        if game_state == "PLAYING":
            ...
            difficulty_mult = 1.0 + score / 2000.0
            spawn_interval = max(0.6, 1.6 - score / 1800.0)
